        ...
        topics: [
            {
                ...
                content: {
                    ...
                    traps: "TRAP 1: The Asymmetry Trap\nIf A is 25% more than B, students often assume B is 25% less than A. THIS IS FALSE. (B=100, A=125 -> B is 20% less than A).\n\nTRAP 2: Successive Addition\n10% discount followed by 10% discount is NOT 20% discount. It is 19% (100 -> 90 -> 81).\n\nTRAP 3: The Base Error (Classic Trap)\nAlways divide by ORIGINAL value in % change questions. Example: Price ₹80 to ₹100 is 25% increase (20/80), not 20% (20/100).",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    logic: "Step 1: The Keyword Scan.\n- If the question asks for 'Greatest', 'Maximum', or 'Largest' to divide things exactly, use HCF.\n- If it asks for 'Smallest', 'Minimum', or 'When will they meet next', use LCM.\nStep 2: Prime Factorization.\n- HCF takes the LOWEST powers of common primes. LCM takes the HIGHEST powers of all primes present.",
                    traps: "TRAP 1: The Multi-Number Mistake\nThe rule 'A × B = LCM × HCF' ONLY works for TWO numbers. It fails for 3+ numbers.\n\nTRAP 2: Decimal Displacement\nTo find HCF of 0.6 and 0.12, equalize decimal places (0.60 and 0.12). Calculate for 60 and 12, then place decimal back.\n\nTRAP 3: GCD vs HCF\nThey are the same! GCD (Greatest Common Divisor) = HCF (Highest Common Factor).",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Basic Average: (Sum of all observations) / (Number of observations).\n2. Weighted Average: (n1*A1 + n2*A2 + ...) / (n1 + n2 + ...).\n3. Average of first 'n' natural numbers: (n + 1) / 2.\n4. Average Speed (Equal Distances): 2xy / (x + y).\n5. Alligation / Mixture Rule: Ratio = (Higher Price - Mean Price) : (Mean Price - Lower Price)",
                    logic: "1. The Assumed Mean Method (Deviation Method):\n- Pick a convenient 'assumed mean' (A) near the middle of your values.\n- Find deviations (d = value - A) for each item.\n- Average = A + (Sum of deviations / n).\n\n2. The Visual Balance:\n- For an AP (Arithmetic Progression), the average is exactly the middle term.\n- For Weighted Averages, if the groups are 10 and 20 (ratio 1:2), the average will be shifted 2/3 of the way toward the larger group.",
                    traps: "TRAP 1: The Average Speed Trap\nIf distances are equal, average speed is the Harmonic Mean: 2ab/(a+b). Example: 60 km/h there and 40 km/h back gives 48 km/h, not 50.\n\nTRAP 2: Including the Excluded\nWhen updating an average after someone joins or leaves, remember to increment or decrement the 'n' value accordingly.\n\nTRAP 3: Zeroes count!\nIf you are averaging $\{10, 20, 0\}$, the average is $30/3 = 10$. Don't ignore the zero.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Simple Interest (SI): (P × R × T) / 100.\n2. CI Amount (A): P × (1 + R/100)^T.\n3. CI alone: Amount - Principal.\n4. CI−SI Difference (for 2 years only): P × (R/100)².\n5. Relation: Amount = Principal + Interest.",
                    logic: "1. The Tree Method (For CI):\n- Calculate interest year-by-year. Add previous years' interest to principal for next year.\n\n2. The Percentage Hike Logic:\n- 10% CI for 2 years is equivalent to a single 21% hike (10 + 10 + 1).\n- Profit shortcut: Use x + y + xy/100 to find effective CI rate.",
                    traps: "TRAP 1: Amount vs Interest\nAlways check if the question asks for 'Net Amount' (P+I) or just 'Interest'.\n\nTRAP 2: Half-Yearly Compilation\nIf interest is compounded half-yearly, the Rate becomes R/2 and Time becomes 2T. Use 6-month slots.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Profit %: (Profit / CP) × 100.\n2. Loss %: (Loss / CP) × 100.\n3. Selling Price (Profit): CP × (100 + P%) / 100.\n4. Discount %: (Discount / MP) × 100.\n5. Selling Price (Discount): MP × (100 - D%) / 100.\n6. Same SP Shortcut: If two items sold at same SP with equal x% profit and x% loss, overall is ALWAYS a LOSS = (x²/100)%.",
                    logic: "1. Fixed Multipliers:\n- 25% Profit → SP = 1.25 * CP\n- 25% Discount → SP = 0.75 * MP\n\n2. The Article Logic:\n- If CP of 15 articles = SP of 12 articles, Gain % = (Difference / Selling Count) * 100 = (3/12)*100 = 25%.",
                    traps: "TRAP 1: The 'Summing' Discount\nSuccessive discounts of 20% and 10% give a 28% net discount, not 30%. (100 -> 80 -> 72).\n\nTRAP 2: Base Mismatch\nMarkup is on CP. Discount is on MP. Profit/Loss is on CP. Never mix the bases.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Together as Workers: (Time A × Time B) / (Time A + Time B).\n2. Together as Pipes: Fill(A) + Fill(B) = (a*b)/(a+b). Fill(A) + Leak(B) = (a*b)/(b-a).\n3. The MDH Formula: (M1 × D1 × H1) / W1 = (M2 × D2 × H2) / W2.\n4. Efficiency: If A is x times faster than B, A takes 1/x of the time.",
                    logic: "1. The LCM (Work Unit) Method:\n- Assume Total Work = LCM of all individual days.\n- Daily Work (Efficiency) = Total Work / Individual Days.\n- Total Time = Total Work / Combined Efficiency.\n\n2. The Piecewise Approach:\n- If someone leaves early, subtract the work they completed before leaving from the total units.",
                    traps: "TRAP 1: The 'Direct Addition' Trap\nNever add days. Always add 'rates' or 'units per day'.\n\nTRAP 2: Negative Work (Leaks)\nIn Pipes & Cisterns, an outlet pipe does 'negative work'. Subtract its unit rate from the fillers.\n\nTRAP 3: Time for Work vs People for Work\nRemember M1D1 = M2D2. If you double the people, you HALVE the time.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. The Conversion: km/h × 5/18 = m/s. m/s × 18/5 = km/h.\n2. Average Speed (Equal Distance): (2ab) / (a + b). [NOT (a+b)/2]\n3. Relative Speed:\n   - Opposite Direction = S1 + S2\n   - Same Direction = |S1 - S2|\n4. Streams: Downstream = Speed + Stream | Upstream = Speed - Stream.",
                    logic: "1. The Train Reference:\n- Crossing Pole/Person: Distance = Train Length.\n- Crossing Platform/Tunnel: Distance = Train Length + Platform Length.\n- Two Trains Crossing: Distance = Sum of Lens; Speed = Relative Speed.\n\n2. Time to Meet:\n- Meeting Time = Initial Distance / Relative Speed.",
                    traps: "TRAP 1: The km/h Conversion\nAlways convert units BEFORE setting up the equation. 72 km/h should instantly be seen as 20 m/s.\n\nTRAP 2: Average Speed Trap\nAverage speed is ALWAYS less than the arithmetic mean if speeds differ. (60 & 40 avg is 48, not 50).",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Square: Area = s² | Diag = s√2 | Area from Diag = d²/2.\n2. Rectangle: Area = l×b | Diag = √(l²+b²).\n3. Pythagorean Triples (The Speed Trick): (3,4,5), (5,12,13), (8,15,17), (7,24,25).\n4. Sphere: Vol = (4/3)πr³ | SA = 4πr².\n5. Cone: Vol = (1/3)πr²h | Slant Height (l) = √(r²+h²).",
                    logic: "1. Unit Matching:\n- Ensure all dimensions are in same units (cm vs m) before calculating.\n- 1000 cm³ = 1 Liter.\n\n2. Triple Recognition:\n- If you see a right triangle with sides 12 and 13, the third side MUST be 5. No calculation needed.",
                    traps: "TRAP 1: The Radius vs Diameter Trap\nAlways check if 'Radius' or 'Diameter' is given. πd² is incorrect; it must be π(d/2)².\n\nTRAP 2: Curved vs Total Surface Area\nCurved (CSA) is only the side. Total (TSA) includes the top and bottom circles.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. The Multiplication Rule: log(A × B) = log A + log B.\n2. The Division Rule: log(A / B) = log A - log B.\n3. The Power Rule: log(Aⁿ) = n × log A.\n4. Base Change: log_b(a) = log(a) / log(b).\n5. Common Values: log 2 ≈ 0.3 | log 3 ≈ 0.47 | log 5 ≈ 0.7 | log 10 = 1",
                    logic: "1. The 'To What Power' Check:\n- Whenever you see log_b(x), ask: 'b to what power is x?'.\n\n2. The Factorization Trick:\n- If you need log 6, find log(2*3) = log 2 + log 3.\n- If you need log 5, use log(10/2) = log 10 - log 2 = 1 - 0.3 = 0.7.",
                    traps: "TRAP 1: Zero & Negatives\nLog is only defined for POSITIVE numbers. log(0) and log(-x) are invalid.\n\nTRAP 2: Sum Separation Error\nlog(A+B) is NOT log A + log B. The rule only works for products.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Basic: P(A) = Favorable / Total Outcomes.\n2. nCr (Choosing r from n): n! / [r! * (n-r)!].\n   - Shortcut for 5C2: (5 * 4) / (2 * 1) = 10.\n   - Shortcut for 10C3: (10 * 9 * 8) / (3 * 2 * 1) = 120.\n3. Probability of 'At Least One': 1 - P(None).",
                    logic: "1. The AND/OR Logic:\n- AND = Multiply probabilities (Event A AND B happen).\n- OR = Add probabilities (Event A OR B happen).\n\n2. The 'At Least 1' Hack:\n- In 3 coin tosses, P(at least 1 Head) = 1 - P(no Heads) = 1 - (1/2)³ = 7/8.",
                    traps: "TRAP 1: The Total Sample Space\nFor 2 dice, total is 36. For 3 coins, total is 8. For a deck, total is 52. Don't miscount the base.\n\nTRAP 2: Picking vs Arranging\nUse nCr for picking (order doesn't matter). Use nPr for arranging (order matters). CUET mostly uses nCr.",
                    examples: [
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Union (A ∪ B): n(A) + n(B) - n(A ∩ B).\n2. Intersection (A ∩ B): The common overlap.\n3. Three-Set Formula: n(A∪B∪C) = n(A)+n(B)+n(C) - [n(A∩B)+n(B∩C)+n(C∩A)] + n(A∩B∩C).",
                    logic: "1. The Inside-Out Strategy:\n- Always fill the deepest intersection (Both/All three) FIRST in a Venn Diagram.\n- Then subtract this from the double-overlaps, then from the main circles.\n\n2. 'Exactly Two' Logic:\n- To find 'Exactly two', add the double-overlaps but subtract 3 × (Triple-overlap).",
                    traps: "TRAP 1: The Double Counting Trap\nAdding A and B without subtracting the intersection counts the overlap twice.\n\nTRAP 2: 'Only A' vs 'A'\n'A' includes the overlap with B. 'Only A' excludes it.",
                    examples: [
            ...
            {
                id: "vedic-math-logic",
                title: "17. Vedic Mathematics & Speed Hacks",
                content: {
                    coreConcept: "1. The Philosophy: Mathematical shortcuts derived from ancient Indian sutras. They focus on pattern recognition to skip traditional multi-line steps.\n2. The Base Method: Multiplying or squaring by comparing numbers to a base like 10, 50, or 100.\n3. Digital Root (Navashesh): A verification tool to check if your answer is correct without re-solving.",
                    formulaBank: "1. Base 100 Multiplication (Nikhilam):\n- (100+a) * (100+b) = (100+a+b) | (a*b)\n2. Squaring numbers ending in 5:\n- n5² = [n * (n+1)] | 25\n3. Square near 50:\n- (50±a)² = (25±a) | a²\n4. Divisibility Hacks:\n- By 11: Diff of alt sum = 0 or 11.\n- By 9: Sum of digits is div by 9.",
                    logic: "1. DIGITAL ROOT (Answer Verification):\n- To check if calculation A * B = C is right, sum the digits of A (keep summing until 1 digit), multiply by digital root of B, and see if it matches digital root of C.\n- Example: 12 (DR=3) * 13 (DR=4) = 156. 3*4=12 (DR=3). 156 DR: 1+5+6=12 (DR=3). MATCHED!\n\n2. MENTAL MULTIPLICATION BY 11:\n- To do 11 * 42: Keep 4 and 2 at ends, sum 4+2=6 in middle. Result = 462.\n\n3. BASE SQUARING (Near 50):\n- 48²: Base 50. Diff is -2. Step 1: 25-2=23. Step 2: 2²=04. Result = 2304.\n- 52²: Diff is +2. Step 1: 25+2=27. Step 2: 2²=04. Result = 2704.",
                    traps: "TRAP 1: Carries in Vedic Blocks\nIf a block like a² is more than 2 digits (e.g., 14²=196), you MUST carry the '1' to the left block.\n\nTRAP 2: Sign Mismatch\nWhen doing (50+a), ensure you add for above 50 and subtract for below 50. Don't swap them.\n\nTRAP 3: Digital Root is not 100%\nIt checks for digit sum, but not for carrying errors that cancel out or decimal placement. Use it as a secondary check.",
                    examples: [
                        { q: "Multiply 103 × 107 using Nikhilam.", a: "11021. (Base 100. Diff 3 and 7. Sum: 103+7=110. Product: 3*7=21. Result: 110/21.)" },
                        { q: "Square of 65.", a: "4225. (6 * 7 = 42. End in 25. Result = 4225.)" },
                        { q: "Multiply 11 × 72.", a: "792. (7 | 7+2=9 | 2. Result = 792.)" },
                        { q: "Square of 46.", a: "2116. (50-4=46. 25-4=21. 4²=16.)" },
                        { q: "Digital root of 123456?", a: "3. (1+2+3+4+5+6 = 21 -> 2+1=3.)" },
                        { q: "Is 12345 divisible by 11?", a: "No. (Sum alt: 1+3+5=9, 2+4=6. Diff=3. Not 0/11.)" },
                        { q: "Square of 98.", a: "9604. (100-2. 98-2=96. 2²=04.)" },
                        { q: "Square of 105.", a: "11025. (110 | 25.)" }
                    ],
                    speedSummary: "- Use Digital Roots for instant verification of complex multi/div.\n- Square near 50/100 to avoid long multiplication."
                }
            }
        ]
    },
