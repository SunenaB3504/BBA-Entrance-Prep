// src/data/computer-awareness/index.js
import { hardwareData } from './hardware.data';
import { softwareAndOsData } from './software-and-os.data';
import { internetAndNetworkingData } from './internet-and-networking.data';
...
export const computerAwarenessData = {
    ...
    'software-and-os.data': softwareAndOsData,
