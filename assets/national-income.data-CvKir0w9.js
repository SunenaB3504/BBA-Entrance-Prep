const e={subject:"Economics",chapter:"National Income & Related Aggregates",examTags:["CUET","CBSE"],studyGuide:{topics:[{id:"eco-u1-t1",title:"Introduction to Macroeconomics",content:{coreConcept:`
...
- **Keynesian Revolution**: J.M. Keynes published "The General Theory" (1936), advocating for government intervention to manage demand.
          `,speedSummary:"Macroeconomics focuses on aggregates like GDP and inflation, influenced by institutions like RBI/SEBI, and rose following the failure of classical theories during the Great Depression."}},{id:"eco-u1-t2",title:"Basic Concepts in Macroeconomics",content:{coreConcept:`
...
- **Interest on National Debt**: Excluded (treated as transfer payment).
          `}},{id:"eco-u1-t3",title:"Circular Flow of Income",content:{coreConcept:`
...
**Equilibrium**: S + T + M = I + G + X
          `}},{id:"eco-u1-t4",title:"National Income Aggregates",content:{coreConcept:`
...
**GDP Deflator** = (Nominal GDP ÷ Real GDP) × 100
          `}}]},flashcards:[{id:"eco-u1-fc1",question:"Define National Income (NNP at FC).",answer:"It is the sum total of factor incomes (rent, wages, interest, profit) earned by normal residents of a country during a year."},{id:"eco-u1-fc2",question:"Difference between Gross and Net investment?",answer:"Gross Investment includes depreciation, while Net Investment excludes it (Net = Gross - Depreciation)."},{id:"eco-u1-fc3",question:"What is a 'Stock' variable?",answer:"A variable measured at a particular point of time (e.g., Wealth, Capital)."},{id:"eco-u1-fc4",question:"What is a 'Flow' variable?",answer:"A variable measured over a period of time (e.g., Income, Expenditure)."},{id:"eco-u1-fc5",question:"Formula for GDP at MP to NNP at FC?",answer:"GDP at MP (-) Depreciation (+) NFIA (-) NIT = NNP at FC."},{id:"eco-u1-fc6",question:"What are Intermediate Goods?",answer:"Goods used for resale or as raw material in the same year. Not included in National Income."},{id:"eco-u1-fc7",question:"What are Transfer Payments?",answer:"Unilateral payments received without any productive service (e.g., Old age pension, scholarships)."},{id:"eco-u1-fc8",question:"Define Operating Surplus.",answer:"Income from property and entrepreneurship (Rent + Interest + Profit)."}],questions:[{id:"eco-u1-q1",type:"mcq",question:"Which of the following is included in National Income?",options:["Old age pension","Interest on national debt","Salary of a teacher","Scholarship to a student"],correct:2,explanation:"Salary of a teacher is factor income (payment for a productive service) and is included. Others are transfer payments.",examTags:["CUET","CBSE"]},{id:"eco-u1-q2",type:"mcq",question:"Real GDP is calculated using:",options:["Current Prices","Base Year Prices","Market Prices","None of these"],correct:1,explanation:"Real GDP uses constant (base year) prices to eliminate the effect of inflation. Formula: $\\text{Real GDP} = \\frac{\\text{Nominal GDP}}{\\text{Price Index}} \\times 100$",examTags:["CUET","CBSE"]},{id:"eco-u1-q3",type:"mcq",question:`Statement 1: Net investment is a stock concept.
Statement 2: Capital is a flow concept.`,options:["Statement 1 is true","Statement 2 is true","Both are true","Both are false"],correct:3,explanation:"Investment is a flow (over time), and Capital is a stock (at a point in time)."},{id:"eco-u1-q5",type:"numerical",question:"GDP at MP = ₹500 cr, Depreciation = ₹50 cr. Find NDP at MP.",options:["₹550 cr","₹450 cr","₹500 cr","₹400 cr"],correct:1,explanation:"NDP at MP = GDP at MP - Depreciation = 500 - 50 = 450."}]};export{e as nationalIncomeData};
