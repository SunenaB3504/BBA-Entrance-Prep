const e={subject:"Economics",chapter:"Money and Banking",examTags:["CUET","CBSE"],studyGuide:{topics:[{id:"eco-u2-t1",title:"Money — Functions and Classification",content:{coreConcept:`
...
- **Legal Tender**: Money that cannot be legally refused for settlement of debt.
          `}},{id:"eco-u2-t2",title:"Money Supply and High Powered Money",content:{coreConcept:`
...
**Formula**: H = Currency with Public + Cash Reserves of Banks.
          `}},{id:"eco-u2-t3",title:"Commercial Banking and Credit Creation",content:{coreConcept:`
...
**Money Multiplier** = 1 / LRR.
          `}},{id:"eco-u2-t4",title:"Central Bank (RBI) and Monetary Policy",content:{coreConcept:`
...
| **DEFLATION** | Decrease Rates, BUY Securities | Rises (Cheap Money Policy) |
          `}}]},flashcards:[{id:"eco-u2-fc1",question:"Define Money Supply.",answer:"Total stock of money held by the public at a specific point in time."},{id:"eco-u2-fc2",question:"What is M1?",answer:"M1 = Currency with Public + Demand Deposits + Other Deposits with RBI."},{id:"eco-u2-fc3",question:"Define High Powered Money.",answer:"Currency with public + Cash reserves of banks (monetary base)."},{id:"eco-u2-fc4",question:"What is Repo Rate?",answer:"The rate at which RBI lends short-term funds to banks against securities."},{id:"eco-u2-fc5",question:"Money Multiplier formula?",answer:"1 / Legal Reserve Ratio (LRR)."}],questions:[{id:"eco-u2-q1",type:"mcq",question:"Which of the following is a function of the Central Bank?",options:["Accepting deposits from public","Custodian of forex reserves","Granting loans to individuals","Profit maximization"],correct:1,explanation:"RBI acts as the custodian of foreign exchange reserves. Commercial banks accept deposits and grant loans for profit."},{id:"eco-u2-q2",type:"mcq",question:"Which measure of money supply is considered the most liquid?",options:["M1","M2","M3","M4"],correct:0,explanation:"M1 is the most liquid measure of money supply: $M1 = C + DD + OD$.",examTags:["CUET","CBSE"]},{id:"eco-u2-q3",type:"mcq",question:"The central bank increases Repo Rate to:",options:["Increase Money Supply","Decrease Money Supply","Increase Liquidity","Encourage Borrowing"],correct:1,explanation:"Higher Repo Rate makes borrowing expensive for commercial banks, leading to a decrease in money supply ($Repo \\uparrow \\Rightarrow MS \\downarrow$).",examTags:["CUET","CBSE"]}]};export{e as moneyBankingData};
